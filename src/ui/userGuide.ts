...
const GUIDES: Record<string, GuideSection> = {
  ...
  guideline: {
    title: "26년도 KDT 운영지침",
    emoji: "📖",
    desc: "고용노동부 KDT 운영지침(2026.2.19 시행) + 운영규정 2종(2026.5.11 개정)을 검색·카테고리로 빠르게 확인하는 매뉴얼 페이지입니다.",
    steps: [
      ...
      { icon: "3️⃣", text: "좌측 사이드에서 14개 카테고리 중 선택 — 클릭 시 해당 섹션으로 스크롤 점프" },
      { icon: "4️⃣", text: "각 항목 카드를 클릭하면 본문 펼침 — 여러 개 동시 펼침 가능" },
      { icon: "5️⃣", text: "Alt+G 모달에서는 ↑↓로 결과 이동 + Enter로 해당 항목 점프 + Esc로 닫기" },
    ],
    tips: [
